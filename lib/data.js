...
const OFFICES = [
  { name: "Office of the Mayor", does: "Executive matters, endorsements, mayor's clearance.", head: "Fulgencio I. Mercado, Municipal Mayor", phone: "(043) 740-6183 \u00b7 (043) 706-3366", email: "mayor@taal.gov.ph" },
  { name: "Sangguniang Bayan", does: "Ordinances, resolutions, council records.", head: "Jovito M. Albufera, Municipal Vice Mayor", phone: "(043) 740-6181 \u00b7 (043) 706-4417", email: "vicemayor@taal.gov.ph" },
...
const SBPHOTOS = [
  "https://news.taal.gov.ph/wp-content/uploads/2013/02/2-1024x692.jpg",
  "https://news.taal.gov.ph/wp-content/uploads/2013/02/IMG_8337-844x1024.jpg"
];

const COUNCIL = [
  { name: "Coun. Ricky B. Villanueva", role: "Sangguniang Bayan Member" },
  { name: "Coun. Erwin Reyes Jr.", role: "Sangguniang Bayan Member" },
  { name: "Coun. Emerson B. Reyes", role: "Sangguniang Bayan Member" },
  { name: "Coun. Nelson B. Casanova", role: "Sangguniang Bayan Member" },
  { name: "Coun. Severiano C. Alcantara", role: "Sangguniang Bayan Member" },
  { name: "Coun. June C. Manimtim", role: "Sangguniang Bayan Member" },
  { name: "Coun. Juanito B. Legaspi", role: "Sangguniang Bayan Member" },
  { name: "Coun. Ma. Adelaida S. Baleros", role: "Sangguniang Bayan Member" },
  { name: "ABC Pres. Felixberto C. De Leon", role: "Ex officio \u00b7 Liga ng mga Barangay" }
];
...
export { SERVICES, NEWS, OFFICES, BARANGAYS, SIGHTS, TPH, MUSEUMS, SSD, LESSER, SBPHOTOS, COUNCIL, FORMS };
